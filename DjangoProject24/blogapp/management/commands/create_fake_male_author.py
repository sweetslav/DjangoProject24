    ...
    def handle(self, *args, **options):
        ...
        try:
            for _ in range(num_authors):
                fake_fname = fake.first_name_male()
                fake_lname = fake.last_name_male()
...
# Эта команда создаст 3 авторов русскими именами с помощью фальшивых данных.
# python manage.py create_fake_male_author --num 3
